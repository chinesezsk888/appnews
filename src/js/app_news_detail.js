...
function webOnChange(obj) {
    ...
    switch (textsize) {
        case "0":
            ...
            webviewDom.classList.remove("fontsm", "fontml", "fontbig", "fontexbig");
            break;
        case "1":
            webviewDom.classList.add("fontsm");
            webviewDom.classList.remove("fontexsm", "fontml", "fontbig", "fontexbig");
            break;
        case "2":
            webviewDom.classList.add("fontml");
            webviewDom.classList.remove("fontexsm", "fontsm", "fontbig", "fontexbig");
            break;
        case "3":
            webviewDom.classList.add("fontbig");
            webviewDom.classList.remove("fontexsm", "fontml", "fontsm", "fontexbig");
            break;
        case "4":
            webviewDom.classList.add("fontexbig");
            webviewDom.classList.remove("fontexsm", "fontml", "fontbig", "fontsm");
            break;
        default:
            console.log('数据不对');
    }
